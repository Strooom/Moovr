...
static constexpr uint32_t outputTimerFrequency        = 80'000U;                                                         // Design parameter resulting in a certain maximum stepping frequency, as well as a minimum Step pulse width and Dir setup timeBefore
...
static constexpr uint32_t minBufferLevel              = 4;
...
class machineProperties {
  public:
    ...
    struct Motors {
        ...
        float aMax[nmbrAxis]{40.0F, 40.0F, 40.0F};              // [mm/s^2]
        float dMax[nmbrAxis]{-40.0F, -40.0F, -40.0F};           // [mm/s^2]
